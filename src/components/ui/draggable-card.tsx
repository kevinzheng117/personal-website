...
export const DraggableCardBody = ({
  ...
  // Remove opacity effect; always fully opaque
  const opacity = 1;
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative min-h-72 w-[28rem] overflow-hidden rounded-md bg-neutral-100 p-6 shadow-2xl transform-3d dark:bg-neutral-900",
        className
      )}
    >
      {children}
